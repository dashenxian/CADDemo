...
namespace AcDotNetTools
{
    public static partial class AddEntityTools
    {
        ...
        {
            // 获取两点的中心点
            Point3d center = point1.MidPoint(point2);
            // 获取半径
            double radius = point1.Distance(center);
        ...
        {
            // 椭圆圆心
            Point3d center = majorPoint1.MidPoint(majorPoint2);
            // 短轴与长轴的比例
            double ratio = 2 * shortRadius / majorPoint1.Distance(majorPoint2);
            // 长轴的向量
